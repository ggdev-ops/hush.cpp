...
/**
 * JNI Bridge for Android Native.
 * Exports C-compatible functions that the Android JVM can call via JNI.
 */
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_hushCreate")
fun hushCreate(env: CPointer<JNIEnvVar>, thiz: jobject, thresholdDb: Double, aggressionLevel: Double, sampleRate: Int): Long {
    return memScoped {
        ...
        hush_engine_create(cConfig.readValue()).toLong()
    }
}

@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_hushProcess")
fun hushProcess(env: CPointer<JNIEnvVar>, thiz: jobject, handle: Long, input: jshortArray): jshortArray? {
    ...
    return memScoped {
        ...
        val outputSamples = alloc<IntVar>().apply { value = inputLen }
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_hushFlush")
fun hushFlush(env: CPointer<JNIEnvVar>, thiz: jobject, handle: Long): jshortArray? {
    ...
    return memScoped {
        ...
        val outputSamples = alloc<IntVar>().apply { value = 4096 }
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_hushGetStats")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_hushDestroy")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_hushGetCurrentDb")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_recorderCreate")
fun recorderCreate(
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_recorderStart")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_recorderStop")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_recorderDestroy")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_recorderIsRecording")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_recorderGetStats")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_recorderGetPressure")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_recorderGetDegradationState")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_recorderGetCurrentDb")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_playerCreate")
fun playerCreate(env: CPointer<JNIEnvVar>, thiz: jobject): Long {
    return hush_player_create().toLong()
}

@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_playerDestroy")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_playerPlay")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_playerPlayBuffer")
fun playerPlayBuffer(env: CPointer<JNIEnvVar>, thiz: jobject, handle: Long, samples: jfloatArray, count: Int, sampleRate: Int): Int {
    ...
    jniEnv.ReleaseFloatArrayElements!!.invoke(env, samples, floatPtr, JNI_ABORT)
    return result
}

@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_playerTogglePause")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_playerStop")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_playerIsPlaying")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_playerIsFinished")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_hushSetLogLevel")
fun hushSetLogLevel(env: CPointer<JNIEnvVar>, thiz: jobject, level: Int) {
    hush_set_log_level(level)
}

@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_hushCalculateRmsDb")
fun hushCalculateRmsDb(env: CPointer<JNIEnvVar>, thiz: jobject, samples: jshortArray): Double {
    ...
    jniEnv.ReleaseShortArrayElements!!.invoke(env, samples, ptr, JNI_ABORT)
    return rms
}

@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushAndroidEngine_hushSaveWav")
