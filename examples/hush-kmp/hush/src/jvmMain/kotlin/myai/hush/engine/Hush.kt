    ...
    companion object {
        ...
        private fun loadNativeLibrary() {
            try {
                ...
                println("[Hush] Loaded myai_hush_jni from system library path")
            } catch (e: UnsatisfiedLinkError) {
                println("[Hush] myai_hush_jni not found in java.library.path, attempting to extract from JAR...")
                
                val tmpDir = java.io.File(System.getProperty("java.io.tmpdir"), "myai_hush_native")
                ...
                try {
                    ...
                    loadIfExist("libmyai_hush_jni.so")
