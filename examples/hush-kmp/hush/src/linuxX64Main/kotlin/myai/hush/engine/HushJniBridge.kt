...
/**
 * JNI Bridge for Linux x64.
 * Exports C-compatible functions that the JVM/Android can call via JNI.
 */
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_hushCreate")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_hushProcess")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_hushFlush")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_hushGetStats")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_hushDestroy")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_hushGetCurrentDb")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_recorderCreate")
fun recorderCreate(
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_recorderStart")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_recorderStop")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_recorderDestroy")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_recorderIsRecording")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_recorderGetStats")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_recorderGetPressure")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_recorderGetDegradationState")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_recorderGetCurrentDb")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_playerCreate")
fun playerCreate(env: CPointer<JNIEnvVar>, thiz: jobject): Long {
    return hush_player_create().toLong()
}

@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_playerDestroy")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_playerPlay")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_playerPlayBuffer")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_playerTogglePause")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_playerStop")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_playerIsPlaying")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_playerIsFinished")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_hushSetLogLevel")
fun hushSetLogLevel(env: CPointer<JNIEnvVar>, thiz: jobject, level: Int) {
    hush_set_log_level(level)
}

@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_hushCalculateRmsDb")
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_myai_hush_engine_HushJvmEngine_hushSaveWav")
